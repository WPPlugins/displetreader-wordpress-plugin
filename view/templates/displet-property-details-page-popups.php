								...
								<div class="displet-content">
									<div class="displet-form">
										...
										<div class="<?php displetretsidx_the_rate_property_container_class(); ?> displet-input">
											...
											<div class="<?php displetretsidx_the_rate_property_1_star_class(); ?>" rating="<?php displetretsidx_the_rate_property_1_star_rating(); ?>">
												1 Star
											</div>
											<div class="<?php displetretsidx_the_rate_property_2_star_class(); ?>" rating="<?php displetretsidx_the_rate_property_2_star_rating(); ?>">
												2 Stars
											</div>
											<div class="<?php displetretsidx_the_rate_property_3_star_class(); ?>" rating="<?php displetretsidx_the_rate_property_3_star_rating(); ?>">
												3 Stars
											</div>
											<div class="<?php displetretsidx_the_rate_property_4_star_class(); ?>" rating="<?php displetretsidx_the_rate_property_4_star_rating(); ?>">
												4 Stars
											</div>
											<div class="<?php displetretsidx_the_rate_property_5_star_class(); ?>" rating="<?php displetretsidx_the_rate_property_5_star_rating(); ?>">
												5 Stars
											</div>
										</div>
