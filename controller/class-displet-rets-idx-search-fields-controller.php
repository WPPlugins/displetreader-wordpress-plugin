...
class DispletRetsIdxSearchFieldsController extends DispletRetsIdxSearchFieldsModel {
	public static function get_search_field_markup( $field ) {
        ...
        switch ( $field['field'] ) {
			...
			case 'new_construction' :
				...
				break;
			case 'open_house' :
				$markup .= self::get_open_house( $field );
				break;
			case 'open_house_within' :
				$markup .= self::get_open_house_within( $field );
				break;
			case 'pool' :
			...
			case 'short_sale' :
				...
				break;
			case 'search_sold':
				$markup .= self::get_search_sold( $field );
				break;
	...
	public static function get_advanced_search_form_column_html( $column_id ) {
		if ( !empty( self::$_search_form_options ) && is_array( self::$_search_form_options ) ) {
	...
	public static function has_quick_search_form( $form_id, $column_id = 1 ) {
