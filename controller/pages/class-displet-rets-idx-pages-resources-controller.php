...
class DispletRetsIdxPagesResourcesController extends DispletRetsIdxPagesController {
	...
	private static function _localize_js() {
		...
		DispletRetsIdxResourcesController::localize_js(
			...
			array(
				'device' => array(
					'is_mobile' => !empty( self::$_model['device']['is_mobile'] ) ? true : false,
					'is_tablet' => !empty( self::$_model['device']['is_tablet'] ) ? true : false,
				),
				'images' => array(
				...
				'options' => array(
					...
					'allow_sitewide_saved_searches' => !empty( self::$_options['allow_sitewide_saved_searches'] ) ? true : false,
					...
					'use_multiple_photos' => !empty( self::$_options['use_multiple_photos'] ) ? true : false,
				...
				'user' => array(
					'can_view_leads' => DispletRetsIdxAgentsModel::is_current_user_agent(),
					'device' => self::$_model['device'],
					'email' => !empty( $current_user->user_email ) ? $current_user->user_email : '',
					'is_logged_in' => is_user_logged_in() ? true : false,
					'login_hash' => !empty( $current_user->user_login ) ? hash( 'md5', $current_user->user_login ) : '',
					'property_ratings' => self::$_model['user_ratings'],
