...
// Pre Get Posts
add_action( 'pre_get_posts', array( 'DispletRetsIdxMobilePageController', 'set_posts_to_first_page' ) );
...
add_action( 'displetretsidx_register_non_api_users_with_api_cron_per_property', array( 'DispletRetsIdxUsersApiController', 'update_user_property_views' ), 10, 2 );
...
add_shortcode( 'DispletLoginRegister', array('DispletRetsIdxDispletLoginRegisterShortcodeController', 'render_shortcode' ) );
