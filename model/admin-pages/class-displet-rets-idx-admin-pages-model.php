...
class DispletRetsIdxAdminPagesModel extends DispletRetsIdxPlugin {
	...
	private static function set_defaults() {
		self::$_model = array(
			...
			'property_details_page_url' => isset( self::$_options['property_details_page_id'] ) ? get_permalink( self::$_options['property_details_page_id'] ) : '',
			'search_results_page_url' => isset( self::$_options['search_results_page_id'] ) ? get_permalink( self::$_options['search_results_page_id'] ) : '',
		);
	}
