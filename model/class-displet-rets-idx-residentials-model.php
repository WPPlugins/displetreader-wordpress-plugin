...
class DispletRetsIdxResidentialsModel extends DispletRetsIdxPlugin {
	...
	protected function get_return_fields() {
		...
		if ( !empty( self::$_options['use_multiple_photos'] ) ) {
			$return_fields[] = 'thumb_image_urls';
		}
	...
	private function remove_empty_query_args() {
		$this->_query_args = array_filter( $this->_query_args );
	}
