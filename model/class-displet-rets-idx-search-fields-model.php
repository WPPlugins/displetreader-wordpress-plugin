...
class DispletRetsIdxSearchFieldsModel extends DispletRetsIdxPlugin {
	public static $fields = array(
		...
		'open_house_within' => array(
			'title' => 'Open House Within',
			'label' => 'Open House',
		),
		'pool' => array(
			'title' => 'Pool',
		...
		'search_sold' => array(
			...
			'label' => 'Show Only Sold Properties',
		),
		'short_sale' => array(
			'title' => 'Short Sale',
			'label' => 'Short Sale',
	...
	private function get_checkbox_markup( $search_field, $title ) {
		$markup =
			'<div id="displet-' . $search_field . '" class="displet-checkbox">
				<label>' . $title . '</label>
				<input type="checkbox" name="' . $search_field . '" class="displet-search-field" value="1">
			</div>';
		return $markup;
	}
	...
	protected static function get_open_house( $field ) {
		return self::get_radio_markup( 'open_house', $field['label'], self::get_yes_no_any_options() );
	}

	protected static function get_open_house_within( $field ) {
		return self::get_select_markup( 'open_house_within', $field['label'], self::get_open_house_within_options() );
	}

	private static function get_open_house_within_options() {
		return array(
			'1' => 'Within 1 Day',
			'2' => 'Within 2 Days',
			'3' => 'Within 3 Days',
	...
	protected static function get_search_sold( $field ) {
		return self::get_checkbox_markup( 'search_sold', $field['label'] );
	}
