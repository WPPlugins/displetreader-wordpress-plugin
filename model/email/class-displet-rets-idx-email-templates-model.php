...
class DispletRetsIdxEmailTemplatesModel extends DispletRetsIdxEmailModel {
	...
	protected static $_option_slugs_for_api_params_without_placeholders = array(
		'header_markup' => 'email_header',
		'footer_markup' => 'email_footer',
	...
	public static function get_default_assigned_lead_message() {
		return
			...
			'Email: %%user_email%%' . PHP_EOL . PHP_EOL .
	...
	public static function get_default_rate_property_message_to_user() {
		return
			'%%properties%%';
	}

	public static function get_default_rate_property_title_to_user() {
		return
			'How Do You Like These Properties?';
	}
