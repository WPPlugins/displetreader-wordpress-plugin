 ...
 * @return: boolean
 */
function displetretsidx_use_registration_phone() {
	global $displetretsidx_template;
	if ( !empty( $displetretsidx_template['options']['include_phone'] ) || !empty( $displetretsidx_template['options']['require_phone'] ) ) {
		return true;
	}
	return false;
}
...
function displetretsidx_use_registration_realtor() {
	global $displetretsidx_template;
	if ( !empty( $displetretsidx_template['options']['include_working_with_realtor'] ) || !empty( $displetretsidx_template['options']['require_working_with_realtor'] ) ) {
		return true;
	}
	return false;
}
 ...
 * @return: boolean
 */
function displetretsidx_use_collaborative_search() {
	return false;
}
 ...
 * @return: print: CSS classname
 */
function displetretsidx_the_registration_collaborator_form_class() {
}

/**
 * @return: print: CSS classname
 */
function displetretsidx_the_add_registration_collaborator_form_class() {
}

/**
 * @return: print: CSS classname
 */
function displetretsidx_the_registration_collaborator_type_class() {
}

/**
 * @return: print: HTML attribute
 */
function displetretsidx_the_registration_collaborator_type_cobuyer_value() {
}

/**
 * @return: print: HTML attribute
 */
function displetretsidx_the_registration_collaborator_type_family_value() {
}

/**
 * @return: print: HTML attribute
 */
function displetretsidx_the_registration_collaborator_type_friend_value() {
}

/**
 * @return: print: CSS classname
 */
function displetretsidx_the_registration_collaborator_name_class() {
}

/**
 * @return: print: CSS classname
 */
function displetretsidx_the_registration_collaborator_email_class() {
}

/**
 * @return: print: CSS classname
 */
function displetretsidx_the_registration_collaborator_phone_class() {
}
