 ...
 */
function displetretsidx_the_listings_class() {
	echo 'displet-listings';
}
...
/**
 * @params: $scroll_wheel: boolean
 * @return: print: HTML markup
 */
function displetretsidx_the_map( $scroll_wheel = true ) {
	echo DispletRetsIdxResidentialsController::get_map_markup( '<div id="displetretsidx_canvas" style="width: 100%; height: 500px;"></div>', $scroll_wheel );
}
