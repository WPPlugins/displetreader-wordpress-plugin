...
class DispletRetsIdxPlugin {
	...
	protected static $_meta_keys = array(
		...
		'lead' => array(
			...
			'assigned_lender_id' => 'displet_lender_id',
			'phone' => 'displet_phone',
		...
		'saved_properties' => 'displet_saved_properties', // Should be deleted, check if used first
	...
	protected static $_version = '2.1.24';
	...
	protected static function _is_network_admin() {
	...
	private static function set_urls() {
		self::$_urls = array(
			...
			'images' => self::$_url . '/includes/css/images',
